...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-5">
      ...
      <span>
      <div style={{ border: "1px solid lightgray", borderRadius: "10px", padding: "10px", background: "lightpink" }}>
  <table>
    <thead>
      <tr>
        <th>ID</th>
    ...
    <tbody>
      {products.map(pro => (
        <tr key={pro.id}>
          ...
          <td><img src={pro.image} alt={pro.title} width={50} height={50} /></td>
        </tr>
      ))}
    </tbody>
  </table>
        ...
        <span style={{ "border": "1px solid lightgray","background":"lightgray","borderRadius":"10px" }}>
          ...
          <style>{
              `
                    ...
                    .increment-button{
                      color:green; border:1px solid green;padding:10px;border-radius:10px;background:lightgreen
                    }

                    .decrement-button{
                      color:red; border:1px solid red;padding:10px;border-radius:10px;background:lightpink
                    }
              `
            }
          </style>
